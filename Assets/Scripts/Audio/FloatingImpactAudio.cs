...
public class FloatingImpactAudio : MonoBehaviour
{
    ...
    public AudioClip solidPlasticSoftBounce;
    public AudioClip solidPlasticHardBounce;
    public AudioClip plasticBagSoftBounce;
    public AudioClip plasticBagHardBounce;
    public AudioClip metalBoxSoftBounce;
    public AudioClip metalBoxHardBounce;
    ...
    void FixedUpdate()
    {
        ...
        if (!bumpSoundOnCoolDown)
        {
            ...
            if (velocityDiff > velocityChangeHardFloor)
            {
                ...
                floatingAudioSource.clip = metalBoxHardBounce; //set sound to play to be the hard bounce sound
            ...
            {
                randomizeAudio(); //randomize the pitch between the min and max values
                floatingAudioSource.clip = metalBoxSoftBounce; //set sound to play to be the hard bounce sound
                floatingAudioSource.Play(); //play the sound
                StartCoroutine(bumpCooldown()); //dont play another sound for a bit
            }
        }
